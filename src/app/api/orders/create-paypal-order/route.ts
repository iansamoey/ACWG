...
async function createPayPalOrder(accessToken: string, total: number): Promise<unknown> {
  const response = await fetch(`${process.env.PAYPAL_SERVER_URL}/v2/checkout/orders`, {
    method: "POST",
    headers: {
