...
import { UserProvider } from '../context/UserContext'; // Adjust based on actual location
import { CartProvider } from '../context/CartContext'; // Adjust based on actual location
